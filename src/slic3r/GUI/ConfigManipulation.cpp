...
//    toggle_line("support_interface_speed", have_support_material && have_support_interface);
    ...
    toggle_line("staggered_perimeter_first_layers", config->opt_bool("staggered_perimeters"));
    toggle_line("staggered_perimeter_last_layers", config->opt_bool("staggered_perimeters"));
